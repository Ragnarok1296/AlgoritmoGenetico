...
def evaluacion():
    ...
    for i in range(0, numPoblacion):
        ...
        while (knapsack_overfield):
            ...
            # Se inicia un ciclo para que se vaya comparando los valores y encontrar el mejor
            # resultado entre ganancia/peso
            for j in range(0,len(optimal_selection)):

                # Se gurada el resultado en una variable ya que se utilizara dos veces
